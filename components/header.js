        ...
        return (
            <header className="site-header sticky-top py-1">
                <nav className="container d-flex flex-column flex-md-row justify-content-between">
                    ...
                    <a className="py-2 d-none d-md-inline-block" href="#">Категории</a>
                    <a className="py-2 d-none d-md-inline-block" href="#">Лучшие товары</a>
                    <a className="py-2 d-none d-md-inline-block" href="#">Справка</a>
                </nav>
            </header>
        )
    }
